...
class GeogigFeatureTest(unittest.TestCase):
    ...
    def testAttributes(self):
        ...
        self.assertEqual("Public", data["usage"])
    ...
    def testDiff(self):
        ...
        areas = diffs["area"]
        self.assertEqual(15297.503295898438, areas[1])
        self.assertEqual(15246.59765625, areas[0])
    ...
    def testFeatureType(self):
        ...
        self.assertEqual("MULTIPOLYGON EPSG:4326", ftype['the_geom'])
    ...
    def testGeomFieldName(self):
        ...
        self.assertEqual("the_geom", name)

    def testNoGeom(self):
        feature = Feature(self.repo, geogig.HEAD, "parks/5")
        allattrs = feature.attributes
        attrs = feature.attributesnogeom
        self.assertEqual(len(allattrs), len(attrs) + 1)
